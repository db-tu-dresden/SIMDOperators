...
namespace tuddbs {
  ...
  class ClusteringSingleColumnSortIndirectInplace {
   ...
   public:
    explicit ClusteringSingleColumnSortIndirectInplace(SimdOpsIterable auto p_data, SimdOpsIterable auto p_idx)
