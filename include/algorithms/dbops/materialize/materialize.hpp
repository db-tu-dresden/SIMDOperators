  ...
  class Materialize {
   ...
   public:
    ...
    auto operator()(SimdOpsIterable auto p_result, SimdOpsIterable auto p_data, SimdOpsIterableOrSizeT auto p_end,
                    SimdOpsIterable auto p_valid_masks, [[maybe_unused]] SimdOpsIterable auto p_valid_masks_end,
                    activate_for_bit_mask<HS> = {}) const noexcept -> decltype(p_result) {
    ...
    auto operator()(SimdOpsIterable auto p_result, SimdOpsIterable auto p_data, SimdOpsIterableOrSizeT auto p_end,
                    SimdOpsIterable auto p_valid_masks, [[maybe_unused]] SimdOpsIterable auto p_valid_masks_end,
                    activate_for_dense_bit_mask<HS> = {}) const noexcept -> decltype(p_result) {
    ...
    auto merge(Materialize<OtherSimdStlye, OtherHintSet, OtherIdof> const &other) noexcept -> void {}
