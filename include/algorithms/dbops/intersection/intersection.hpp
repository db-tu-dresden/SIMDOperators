...
#ifndef SIMDOPS_INCLUDE_ALGORITHMS_DBOPS_INTERSECTION_INTERSECTION_HPP
#define SIMDOPS_INCLUDE_ALGORITHMS_DBOPS_INTERSECTION_INTERSECTION_HPP
   ...
   public:
    ...
    auto operator()(SimdOpsIterable auto p_result, SimdOpsIterable auto p_left_data,
      ...
      for (; p_left_data != simd_end; p_left_data += SimdStyle::vector_element_count(),
        ...
        auto const result = tsl::binary_and<SimdStyle, Idof>(left_reg, right_reg);
        if constexpr (has_hint<HintSet, hints::memory::aligned>) {
