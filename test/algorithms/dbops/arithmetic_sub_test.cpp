...
T get_random_val(size_t seed = 0) {
  ...
  ssize_t min_bound = 1;
  uniform_distribution<T> dist(min_bound, numeric_max);
  return dist(mt);
}
...
TEST_CASE("Subtract 2 columns, scalar", "[scalar]") {
...
TEST_CASE("Subtract 2 columns, sse", "[sse]") {
  std::cout << Catch::getResultCapture().getCurrentTestName() << std::endl;
...
TEST_CASE("Subtract 2 columns, avx2", "[avx2]") {
  std::cout << Catch::getResultCapture().getCurrentTestName() << std::endl;
...
TEST_CASE("Subtract 2 columns, avx512", "[avx512]") {
  std::cout << Catch::getResultCapture().getCurrentTestName() << std::endl;
...
TEST_CASE("Subtract 2 columns, neon", "[neon]") {
  std::cout << Catch::getResultCapture().getCurrentTestName() << std::endl;
